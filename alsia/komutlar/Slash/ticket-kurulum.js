...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const yetkiliMi = kullaniciRolleri.has(ayarlar.Yetkiler.yetkiliRolId);
    ...
    const ticket = new EmbedBuilder()
      ...
      .setDescription(
        ...
        <a:gzlk:1327600232963248239>・\`ɢᴇɴᴇʟ ᴅᴇꜱᴛᴇᴋ:\` *Genel olarak desteğe ihtiyacınız varsa bu kategoriyi seçebilirsiniz.*

        <a:5961darkbluetea:1327585257578561548>・\`ᴍᴜʟᴀᴋᴀᴀᴛ ᴅᴇꜱᴛᴇᴋ:\` *Mülakat için bu kategoriyi seçebilirsiniz.*
