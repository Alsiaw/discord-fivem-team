...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const categoryId = ayarlar.Ticket.parentCategory;
        ...
        if (channel.type === ChannelType.GuildText && channel.parentId === categoryId) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`**${interaction.user.username}** tarafından <#${channel.id}> isimli kanalın ismi \`${oldName}\` iken \`${newName}\` olarak güncellenmiştir.`);
            ...
            if (logChannel) {
                const logEmbed = new EmbedBuilder()
                    ...
                    .setDescription(`<:8676gasp:1327585524231176192>・*Kullanıcı* <@${interaction.user.id}> *ticket kanalının ismini değiştirdi.*`)
                    .addFields(
